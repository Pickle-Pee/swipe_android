...
import { StyleSheet, Alert, TouchableOpacity, TouchableWithoutFeedback, Keyboard, ViewStyle, TextStyle, SafeAreaView, Image, KeyboardAvoidingView, View, Text, Pressable, TouchableNativeFeedback } from 'react-native';
