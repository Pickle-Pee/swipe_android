...
const HPanel:FC<IHPanel>=({punkVariable,setPunkVariable})=>{
    ...
    return(
        ...
        <Pressable 
            ...
            onPress={()=>setPunkt(0)}
        > 
            <Text style={[styles.punktText,{color:punkt==0?"#E62885":"black"}]}>
            Ты нравишься
            </Text>
        </Pressable>
        <Pressable 
            ...
            onPress={()=>setPunkt(1)}
        >
             <Text style={[styles.punktText,{color:punkt==1?"#E62885":"black"}]}>
                Ты нравишься
            </Text>
        </Pressable>
        <Pressable 
        ...
        >
              {/* <LinearGradientText 
                ...
                colors={punkt==2?["#E62885", "#009ADA"]:["#000000","#000000"]}
                start={{ x: 0, y: 0 }}
                end={{ x: 1, y: 0 }}
            /> */}
            <Text style={[styles.punktText,{color:punkt==2?"#E62885":"black"}]}>
                Ты нравишься
            </Text>
        </Pressable>
    </View>
